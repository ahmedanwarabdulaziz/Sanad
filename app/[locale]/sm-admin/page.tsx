...
import { MobileFriendlySelect } from "../n-admin/components";
...
const MOBILE_PROMPT_KEY = "sm_admin_mobile_prompt_dismissed";
...
export default function SMAdminLoginPage() {
  ...
  const handleLogin = async () => {
    ...
    sessionStorage.setItem("sm_admin_user", JSON.stringify(user));
    window.location.href = "/sm-admin/dashboard";
  };
